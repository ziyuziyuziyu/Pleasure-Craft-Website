...
export const ProjectPage = (props) => {
  ...
  //this will hide the custom play bar
  /*
  useEffect(() => {
    if (!largeScreen) {
      if (playing) {
  ...
  useEffect(() => {
    ...
    if (container && player) {
      if (expanded) {
        ...
        container.style.backgroundColor = "rgb(237,239,240)";
      ...
      >
        ...
        >
          <ReactPlayer
            ...
            playsinline
            // fluid={true}
            controls={showControls} //comment out this line to hide controls
      ...
      >
        ...
        >
          ...
          <Grid item xs={12} md={"auto"}>
            ...
            >
              PROJECT<br></br>{projectName.toUpperCase()}
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} md={3}>
            ...
            >
              CLIENT<br></br>{client.toUpperCase()}
            </Typography>
          </Grid>
        </Grid>
        ...
        {!largeScreen && (
          ...
          <Typography
            ...
            style={{
              fontFamily: "Square721",
              textAlign: "justify",
              fontSize: largeScreen ? ".6rem" : ".6rem",
              zIndex:"+30",
            }}
          >
            {writeup.toUpperCase()}
